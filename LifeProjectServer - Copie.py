...
genders = ['male','female']
maleNames = ["Manuel","Terrence","Valentin","Léo","William","Carlos","Guillaume","François","Anthony","Jack","Diego","Lucas","David","Xavier","Jacob","Carl","Jean","Yannick","Nicolas","Giordano","Beza","Mario","Brayan","Florient","Alexandre","Bartolomé"]
...
lastNames = ["Martin","Robert-Charrue","Masnaghetti","Garcia","Marques de Matos","Guillet","Comé","Nunes","Langenbach","Marti","Micheli","Archier","Canales","Padin","Lacroix","Oliveira","Gonzales","Carvalho","Lannister","Calvin","Fioriti","Schregler","Savary","Sudan"]
#endregion
